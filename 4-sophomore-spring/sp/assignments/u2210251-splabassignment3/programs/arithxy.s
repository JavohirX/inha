...
#keyboard, performs long integer addition x+y, subtraction x-y,
#multiplication x*y, division x/y and prints the results
# The inputs x & y are to be read from the keyboard.
...
format: .asciz "%ld\n"
message1: .asciz "ENTER A LONG INTEGER x="
message2: .asciz "ENTER A LONG INTEGER y="
message3: .asciz "ENTERED VALUE OF x="
message4: .asciz "ENTERED VALUE OF y="
message5: .asciz "SUM = x + y ="
message6: .asciz "DIFFERENCE = x - y ="
message7: .asciz "PRODUCT = x * y ="
message8: .asciz "QUOTIENT = x / y ="
message9: .asciz "REMINDER = x % y ="
...
#Parametes passed - scanf format f in %rdi and address of x in %rsi
...
#Parametes passed - scanf format f in %rdi and address of y in %rsi
movq $0, %rax # clear rax
movq $f, %rdi # load format string
